...
export const CODEX_ENTRIES: CodexEntry[] = [
  {
    ...
    difficulty: 2,
    keys_primary: ["Emotional", "Leading"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Emotional honesty has to be explicitly authorized by leadership before a strained room can become real.",
    root_distortion: "Leaders often use this move performatively while still protecting image, certainty, or pace. Then the ritual becomes theater.",
    before_you_run: "Ask yourself: *What is the real weather in me that I would rather manage privately than name publicly?* Name one feeling and one pressure before the meeting starts.",
    what_this_nourishes: "Restores **Culture** by making honesty more normal and strengthens **Relationship** by lowering the cost of truth.",
  ...
  },
  {
    ...
    keys_primary: ["Emotional", "Leading"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Quick repair requires emotional responsibility and leadership maturity more than eloquence.",
    root_distortion: "If shame is driving, the repair becomes self-protection, over-explaining, or subtle blame.",
    before_you_run: "Write two short lines: *What was mine?* and *What impact do I suspect I had?* Stop before justification appears.",
    what_this_nourishes: "Protects **Relationship** through honest repair and strengthens **Culture** by teaching that rupture is normal and repair is expected.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Spiritual", "Emotional"],
    keys_secondary: ["Leading"],
    keys_notes: "This move only works when hidden fear is named as a moral and emotional reality, not merely a communication issue.",
    root_distortion: "People may frame the conversation as a clever exercise while avoiding the real fear of consequence, rejection, or exposure.",
    before_you_run: "Ask: *What truth am I hoping someone else will say first?* Name the feared consequence in plain language.",
    what_this_nourishes: "Clarifies **Identity** through courage and integrity, and repairs **Culture** by exposing the true cost of silence.",
  ...
  },
  {
    ...
    difficulty: 3,
    keys_primary: ["Technical", "Leading"],
    keys_secondary: ["Emotional"],
    keys_notes: "Most confusion that feels interpersonal is actually structural. Good leadership names the structure.",
    root_distortion: "Leaders may use ambiguity to retain control while complaining about misalignment.",
    before_you_run: "Identify one place where unclear authority is benefiting you, protecting you, or helping you avoid a harder leadership call.",
    what_this_nourishes: "Strengthens **Vision** through clearer execution and stabilizes **Culture** by reducing ambiguity and politics.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Technical", "Leading"],
    keys_secondary: ["Physical", "Emotional"],
    keys_notes: "Meetings are not neutral containers; they are recurring formation rituals.",
    root_distortion: "Leaders often preserve bad meetings because they soothe anxiety, signal diligence, or avoid clearer accountability.",
    before_you_run: "Ask: *What fear is this meeting currently serving?* Then ask: *What actual output would make that fear unnecessary?*",
    what_this_nourishes: "Repairs **Culture** by changing what becomes normal and supports **Identity** by treating people's time as worthy of stewardship.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Technical", "Physical"],
    keys_secondary: ["Leading"],
    keys_notes: "Capacity is both strategic and embodied. Saying no is not just tactical; it is moral.",
    root_distortion: "Overcommitment often masquerades as generosity, ambition, or sacrifice while quietly hollowing the team.",
    before_you_run: "List the three current commitments most sustained by fantasy rather than real capacity.",
    what_this_nourishes: "Restores **Vision** through real tradeoffs and protects **Culture** by signaling that capacity matters.",
  ...
  },
  {
    ...
    keys_primary: ["Emotional", "Leading"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Dissent requires both emotional safety and leadership permission.",
    root_distortion: "Leaders may invite dissent symbolically but punish it with defensiveness, speed, or subtle reputational cost.",
    before_you_run: "Decide in advance how you will respond if someone surfaces a risk that embarrasses your preferred decision.",
    what_this_nourishes: "Strengthens **Relationship** through safer disagreement and improves **Vision** by protecting decision quality.",
  ...
  },
  {
    ...
    keys_secondary: ["Leading"],
    keys_notes: "Belonging becomes usable when it can be named concretely instead of admired abstractly.",
    root_distortion: "Teams may confuse friendliness with belonging or mistake low conflict for genuine relational trust.",
    before_you_run: "Ask yourself whether you actually want the honest answer, especially if the answer reveals distance you have normalized.",
    what_this_nourishes: "Deepens **Relationship** through measurable belonging and helps **Culture** become more human, not just more cordial.",
  ...
  },
  {
    ...
    difficulty: 3,
    keys_primary: ["Leading", "Technical"],
    keys_secondary: ["Emotional"],
    keys_notes: "Closure requires authority, clarity, and emotional maturity under imperfect conditions.",
    root_distortion: "This move gets weaponized when leaders use it to cut off honest tension instead of metabolizing it.",
    before_you_run: "Check whether the room has actually been heard, or whether you are reaching for closure because ambiguity is emotionally costly to you.",
    what_this_nourishes: "Supports **Vision** through movement and protects **Culture** by teaching that commitment can follow honest disagreement.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Technical"],
    keys_secondary: ["Physical"],
    keys_notes: "Focus is an act of formation. What a team protects becomes what a team worships.",
    root_distortion: "Teams often choose 'the one thing' rhetorically while preserving ten other hidden priorities.",
    before_you_run: "Name one other thing you are willing to disappoint so the chosen priority can become real.",
    what_this_nourishes: "Sharpens **Vision** and strengthens **Culture** by teaching that importance must be protected, not merely admired.",
  ...
  },
  {
    ...
    keys_primary: ["Emotional", "Leading"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Mirroring trains humility and presence before persuasion.",
    root_distortion: "People often mirror mechanically while still internally preparing their rebuttal.",
    before_you_run: "Ask: *Am I trying to understand, or am I trying to win more gracefully?*",
    what_this_nourishes: "Restores **Relationship** by reducing escalation and supports **Identity** through practiced humility.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Leading", "Emotional"],
    keys_secondary: ["Technical"],
    keys_notes: "Trust grows through repeated embodied integrity, not verbal reassurance.",
    root_distortion: "Leaders often attempt symbolic trust-repair while avoiding the concrete promise they can actually keep.",
    before_you_run: "Choose a promise small enough to keep with absolute integrity, not one large enough to sound impressive.",
    what_this_nourishes: "Repairs **Relationship** and gradually reforms **Culture** around kept promises instead of speeches.",
  ...
  },
  {
    ...
    keys_primary: ["Technical", "Leading"],
    keys_secondary: ["Emotional"],
    keys_notes: "Anxiety often lives in vagueness. Clarity is a relational kindness.",
    root_distortion: "Leaders sometimes preserve role blur because it keeps options open or preserves informal control.",
    before_you_run: "Identify where you benefit from the current fuzziness, even if unintentionally.",
    what_this_nourishes: "Strengthens **Identity** through role clarity and supports **Culture** by reducing anxiety and politics.",
  ...
  },
  {
    ...
    keys_primary: ["Leading", "Emotional"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Coaching forms agency when the leader resists the urge to rescue.",
    root_distortion: "Leaders often give advice too quickly because another person's uncertainty triggers their own discomfort.",
    before_you_run: "Ask: *Can I stay present long enough for their thinking to emerge without proving my usefulness too quickly?*",
    what_this_nourishes: "Builds **Identity** through agency and deepens **Relationship** through non-controlling support.",
  ...
  },
  {
    ...
    keys_primary: ["Emotional", "Leading"],
    keys_secondary: ["Technical"],
    keys_notes: "Good feedback protects dignity while remaining behaviorally concrete.",
    root_distortion: "Feedback often becomes a covert discharge of irritation, disappointment, or superiority.",
    before_you_run: "Separate the observable behavior from the story you have built about the person.",
    what_this_nourishes: "Strengthens **Relationship** through dignity-preserving honesty and supports **Culture** by making growth more learnable.",
  ...
  },
  {
    ...
    keys_primary: ["Leading", "Emotional"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Future-oriented learning reduces shame and increases agency.",
    root_distortion: "If the past remains emotionally unresolved, feedforward can become premature optimism layered over unprocessed failure.",
    before_you_run: "Name the lingering shame or discouragement still attached to the target moment before shifting to the future.",
    what_this_nourishes: "Reinforces **Identity** as capable of growth and improves **Culture** by framing mistakes as learnable rather than defining.",
  ...
  },
  {
    ...
    difficulty: 4,
    keys_primary: ["Leading", "Emotional"],
    keys_secondary: ["Spiritual", "Technical"],
    keys_notes: "This is a stewardship move: clarity without cruelty, care without avoidance.",
    root_distortion: "Many leaders slide toward either softness that enables or hardness that threatens, depending on what discomfort they are avoiding.",
    before_you_run: "Decide whether your main temptation is to soften the standard or weaponize it. Correct yourself before entering the conversation.",
    what_this_nourishes: "Protects **Relationship** while strengthening **Culture** around trustworthy standards.",
  ...
  },
  {
    ...
    keys_secondary: ["Emotional", "Physical"],
    keys_notes: "Boundaries are not the enemy of service; they are one way service remains truthful.",
    root_distortion: "People-pleasing, fear of disapproval, or exhaustion often hide beneath a vague or resentful yes.",
    before_you_run: "Ask: *What am I afraid this no will cost me?* Then write the clearest truthful yes you can actually sustain.",
    what_this_nourishes: "Strengthens **Identity** through integrity and protects **Culture** from hidden resentment and false capacity.",
  ...
  },
  {
    ...
    keys_primary: ["Emotional"],
    keys_secondary: ["Leading"],
    keys_notes: "Recovery after failure is a form of formation. It teaches whether truth or ego governs the system.",
    root_distortion: "Shame will try to turn a miss into self-protection, delay, excuse-making, or disappearance.",
    before_you_run: "Write the owning sentence without explanation first. Then build the repair plan underneath it.",
    what_this_nourishes: "Reinforces **Identity** through honest ownership and builds **Culture** around resilient integrity.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Technical"],
    keys_secondary: ["Leading", "Spiritual"],
    keys_notes: "Shared direction becomes real when it is compressible into language people can actually remember and use.",
    root_distortion: "Leaders often keep the goal vague because precision would force tradeoffs and expose disagreement.",
    before_you_run: "Ask: *What future are we still describing in vibes because no one wants to make the sentence demanding enough to matter?*",
    what_this_nourishes: "Clarifies **Vision** and strengthens **Culture** by giving the team a shared reference point.",
  ...
  },
  {
    ...
    difficulty: 3,
    keys_primary: ["Spiritual"],
    keys_secondary: ["Technical", "Emotional"],
    keys_notes: "Old goals linger not just structurally but emotionally and morally. Burial must be public.",
    root_distortion: "Teams often keep serving the ghost goal because it once carried identity, loyalty, or meaning.",
    before_you_run: "Name what part of you or the group still feels faithful to the old goal, even if it no longer deserves current energy.",
    what_this_nourishes: "Restores **Vision** through honest re-alignment and protects **Culture** from legacy drag.",
  ...
  },
  {
    ...
    keys_primary: ["Technical"],
    keys_secondary: ["Leading"],
    keys_notes: "A team that cannot define success will default to activity.",
    root_distortion: "Teams often preserve fuzzy success conditions because evidence would threaten current narratives of progress.",
    before_you_run: "Ask: *What would be harder to hide if success were made observable?*",
    what_this_nourishes: "Strengthens **Vision** by clarifying success and reforms **Culture** around evidence instead of effort theater.",
  ...
  },
  {
    ...
    keys_primary: ["Technical", "Leading"],
    keys_secondary: ["Physical"],
    keys_notes: "Honest leadership names cost. Capacity is finite whether or not the team admits it.",
    root_distortion: "Leaders often want strategic clarity without grieving what clarity requires them to stop, slow, or disappoint.",
    before_you_run: "Name one loss this decision creates that you are tempted to hide in order to keep the yes feeling cleaner.",
    what_this_nourishes: "Clarifies **Vision** and strengthens **Culture** by reconnecting promises to reality.",
  ...
  },
  {
    ...
    keys_primary: ["Leading", "Emotional"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Culture changes when authority explicitly authorizes the behavior the culture claims to value.",
    root_distortion: "Permission becomes hollow if the leader still punishes the behavior emotionally, socially, or reputationally.",
    before_you_run: "Decide exactly how you will respond the first time someone actually uses the permission you are about to grant.",
    what_this_nourishes: "Repairs **Culture** by lowering social uncertainty and strengthens **Relationship** through safer candor.",
  ...
  },
  {
    ...
    difficulty: 3,
    keys_primary: ["Spiritual", "Emotional", "Leading"],
    keys_secondary: ["Technical"],
    keys_notes: "This is a culture-truth move. It reveals what the system actually worships.",
    root_distortion: "Leaders may ask for shadow norms while secretly hoping the brochure will still win.",
    before_you_run: "Ask yourself which unwritten rule you benefit from most, even if you publicly disagree with it.",
    what_this_nourishes: "Restores **Culture** through truth and supports **Identity** by reducing the split between stated and lived values.",
  ...
  },
  {
    ...
    difficulty: 2,
    keys_primary: ["Physical", "Technical"],
    keys_secondary: ["Emotional", "Leading"],
    keys_notes: "Burnout is often systemic before it is personal. Energy is a design issue as much as a resilience issue.",
    root_distortion: "Teams often spiritualize endurance or emotionalize exhaustion while avoiding the structural leak.",
    before_you_run: "Ask: *What drain have we normalized because changing it would require real redesign?*",
    what_this_nourishes: "Protects **Culture** by honoring sustainable capacity and supports **Relationship** by reducing ambient depletion.",
  ...
  },
  {
    ...
    keys_primary: ["Emotional", "Leading"],
    keys_secondary: ["Spiritual"],
    keys_notes: "Honest culture needs a repeatable linguistic doorway into candor.",
    root_distortion: "The phrase becomes cosmetic if the room still penalizes honest content once it arrives.",
    before_you_run: "Prepare yourself to reward the first real act of candor, especially if it is inconvenient to your image or plan.",
    what_this_nourishes: "Strengthens **Culture** through repeatable candor and deepens **Relationship** by lowering the risk of honesty.",
