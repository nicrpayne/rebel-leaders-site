...
export default function Manifesto() {
  ...
  return (<>
    <PageLayout hideFooter={gameVisible}>
      {/* Hero */}
        ...
        <div className="relative z-10 container text-center">
          ...
          <FadeIn delay={0.45}>
            <div className="mt-6 flex justify-center">
              ...
              >
                <span className="font-pixel text-2xl text-gold/40 hover:text-gold/70 transition-colors cursor-pointer select-none" title="X marks the spot...">
                  ✕
                </span>
              </EasterEgg>
            </div>
    ...
    <ManifestoRunner onVisibilityChange={setGameVisible} />
  </>);
}
