...
const CommunityWall = ({
        ...
        entries.map((entry, index) => {
          return new Promise<{
            ...
            img.onload = () => {
              ...
              resolve({
                src: entry.imageUrl,
                alt: `Journal entry from ${entry.createdAt ? entry.createdAt.toLocaleDateString() : ""}`,
                key: entry.id,
  ...
  const openPhotoSwipe = (index: number) => {
    ...
    const options = {
      ...
      showAnimationType: "zoom" as const,
      hideAnimationType: "zoom" as const,
