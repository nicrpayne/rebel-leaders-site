...
- [ ] Review easter eggs, XP system, and collectibles idea
- [ ] Build out the rest of the plugin card covers/designs for Workbench

## Phase 94: Gravitas rotary knob — Apple-quality tactile feel
- [x] Study current RotaryKnob implementation
- [x] Research premium knob UX patterns (detents, momentum, audio)
